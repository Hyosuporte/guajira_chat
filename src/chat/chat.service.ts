...
export class ChatService {
  ...
  async processMessage(messages: any[]): Promise<any> {
    const result = streamText({
      ...
      system: `Eres un asistente experto en SQL especializado en la base de datos GUAJIRA2021_PROD. Tu objetivo es ayudar a los usuarios a consultar datos y generar reportes.
      ...
      temperature: 0,
      tools: this.chatToolsService.getTools(),
    });
    return result;
  }
}
